...
class LinkAndImageSplitterTest(unittest.TestCase):
    ...
    def test_link_without_preceeding_text(self):
        node = TextNode(
    ...
    def test_image_without_preceeding_text(self):
        node = TextNode(
    ...
    # Below are the tests provided by Boot.dev post-submission
    ...
    # Wrote this one myself based on previous test
    def test_split_links_images_trailing_text(self):
        node = TextNode(
